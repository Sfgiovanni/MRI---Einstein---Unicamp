...
if __name__ == "__main__":
    ...
    features_path = args.features or f"features/{args.dataset}_brainiac_features.parquet"
    ...
    feature_cols = [c for c in features_df.columns if c.startswith("emb_")]

    run_cv(features_df, folds_df, feature_cols, "brainiac", output_dir)
